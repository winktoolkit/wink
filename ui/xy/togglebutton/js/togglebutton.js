...
define(['../../../../_amd/core'], function(wink)
{
	 ...
	 * 
	 * @compatibility iOS2, iOS3, iOS4, iOS5, iOS6, Android 1.5, Android 2.1, Android 2.2, Android 2.3, Android 3.0, Android 3.1, Android 4.0, Android 4.1.2, BlackBerry 6, BlackBerry 7, BB10, Bada 1.0, Windows Phone 7.5, Windows Phone 8
	 * 
	...
	wink.ui.xy.ToggleButton.prototype = 
	{
		...
		{
			wink.ux.touch.addListener(this._domNode, "start", { context: this, method: "_startdrag" }, { preventDefault: true, touchAction: "double-tap-zoom" });
