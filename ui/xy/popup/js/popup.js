		...
		popup: function(options)
		{
			...
			if (wink.isSet(opt.targetNode)) {
				...
				if (arrowValue == "bottom") {
					topValue = wink.getTopPosition(opt.targetNode) - this._domNode.offsetHeight - 10 + "px";
				} else if (arrowValue == "top") {
					topValue = wink.getTopPosition(opt.targetNode) + opt.targetNode.offsetHeight + 10 + "px";
				}
