...
public class HtmlCharsetDetector {
	...
	public static void main(final String argv[]) throws Exception {
		...
		final int lang = (argv.length == 2) ? Integer.parseInt(argv[1]) : nsPSMDetector.ALL;
		final nsDetector det = new nsDetector(lang);
		...
		final URL url = new URL(argv[0]);
		final BufferedInputStream imp = new BufferedInputStream(url.openStream());
