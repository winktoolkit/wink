...
public class nsEUCSampler {
	...
	boolean Sample(final byte[] aIn, final int aLen) {
	...
	float GetScore(final float[] aFirstByteFreq, final float aFirstByteWeight, final float[] aSecondByteFreq, final float aSecondByteWeight) {
	...
	float GetScore(final float[] array1, final float[] array2) {
		float s;
		float sum = 0.0f;
