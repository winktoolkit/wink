...
doh._mixin = function(/* Object */obj, /* Object */props)
{
	...
	if (this["document"] && document.all && (typeof props["toString"] == "function") && (props["toString"] != obj["toString"]) && (props["toString"] != tobj["toString"]))
	{
...
doh.extend(doh.Deferred,
	...
	{
	// summary: Replaces outer getTextCallback's in nested situations to avoid multiple
	// callback(true)'s
	var _this = this;
	return function()
	{
	...
	cancel: function()
	{
		...
		} else if (this.fired == 0 && (this.results[0] instanceof doh.Deferred))
		{
...
doh.registerTestNs = function(/* String */group, /* Object */ns)
{
	...
	for ( var x in ns)
	{
		if ((x.charAt(0) != "_") && (typeof ns[x] == "function"))
		{
...
doh.register = doh.add = function(groupOrNs, testOrNull, type)
{
	...
	if ((arguments.length == 1) && (typeof groupOrNs == "string"))
	{
		...
		doh.registerDocTests = function(module)
		{
			...
			for ( var i = 0; i < len; i++)
			{
				...
				if (test.commands.length && test.commands[0].indexOf("//") != -1)
				{
					...
					comment = ", " + parts[parts.length - 1]; // Get all after the last //, so we
					// dont
					// get trapped by http:// or alikes :-).
				}
				tests.push(
						{
...
doh.e = doh.assertError = function(/* Error object */expectedError, /* Object */scope, /* String */functionName, /* Array */args, /* String? */hint)
{
	...
	// example:
	// t.assertError(dojox.data.QueryReadStore.InvalidAttributeError, store, "getValue", [item, "NOT
	// THERE"]);
	// t.assertError(dojox.data.QueryReadStore.InvalidItemError, store, "getValue", ["not an item",
	// "NOT THERE"]);
	try
	{
...
doh.is = doh.assertEqual = function(/* Object */expected, /* Object */actual, /* String? */hint)
{
	...
	if ((expected === actual) || (expected == actual) || (typeof expected == "number" && typeof actual == "number" && isNaN(expected) && isNaN(actual)))
	{
		return true;
	}
	if ((this._isArray(expected) && this._isArray(actual)) && (this._arrayEq(expected, actual)))
	{
		return true;
	}
	if (((typeof expected == "object") && ((typeof actual == "object"))) && (this._objPropEq(expected, actual)))
	{
		return true;
	}
...
doh.isNot = doh.assertNotEqual = function(/* Object */notExpected, /* Object */actual, /* String? */hint)
{
	...
	if ((this._isArray(notExpected) && this._isArray(actual)) && (this._arrayEq(notExpected, actual)))
	{
		throw new doh._AssertFailure("assertNotEqual() failed: not expected |" + notExpected + "| but got |" + actual + "|", hint);
	}
	if (((typeof notExpected == "object") && ((typeof actual == "object"))) && (this._objPropEq(notExpected, actual)))
	{
		throw new doh._AssertFailure("assertNotEqual() failed: not expected |" + notExpected + "| but got |" + actual + "|", hint);
	}
	return true;
...
doh._objPropEq = function(expected, actual)
{
	...
	for (x in actual)
	{ // Lets check "actual" here, expected is checked below.
...
{
	return (it && it instanceof Array || typeof it == "array" || (!!doh.global["dojo"] && doh.global["dojo"]["NodeList"] !== undefined && it instanceof doh.global["dojo"]["NodeList"]));
};
		...
		if (iterations)
		{
			...
			var trialRunner = function()
			{
				...
				tTimer.addCallback(function(end)
					...
					doh.debug("\n\t\tTRIAL #: " + tResults.trial + "\n\tTIME: " + tResults.executionTime + "ms.\n\tAVG TEST TIME: " + (tResults.executionTime / tResults.testIterations) + "ms.");
...
doh._runFixture = function(groupName, fixture)
{
	...
	try
	{
		...
		if (fixture["runTest"])
		{ // should we error out of a fixture doesn't have a runTest?
...
/** *************************************************************** */
/** WINK RUNNER (Based on the EmbedJS version) * */
/** *************************************************************** */
...
doh._groupFinished = function(group, success)
{
	if (typeof this._stats.groupsByName[group].endTime != 'undefined')
...
{
	document.getElementById("testBoxContainer").innerHTML = doh._testBoxes[id];
};
