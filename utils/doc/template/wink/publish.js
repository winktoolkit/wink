...
function publish(symbolSet) {
	publish.conf = {  // trailing slash expected for dirs
		...
		templateName: "Wink",
		templateVersion: "1.0",
		templateLink: "http://www.winktoolkit.org/"
	};
	...
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.imagesDir+"wink_header_menu_selected_bg.png", publish.conf.outDir+"/"+publish.conf.imagesDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.imagesDir+"wink_header_logo.png", publish.conf.outDir+"/"+publish.conf.imagesDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.imagesDir+"wink_bg.png", publish.conf.outDir+"/"+publish.conf.imagesDir);}
...
/** replace WINK_ROOT_URL in the documentation by the actual wink root link **/
function checkTestLinks(str, replacement)
{
	str = (str.toString()).replace(/WINK_ROOT_URL/gi, replacement);
	return str;
}